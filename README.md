...
[![My Skills](https://skillicons.dev/icons?i=ts,js,cs,cpp,css,html,matlab,latex,dotnet,godot,electron,svelte,react,express,nest,nodejs,discord,bots,discordjs,ps,pr,ai,blender,mysql,github,vscode,rider,webstorm,clion,arduino,docker,python,matlab,ros&perline=9)](https://skillicons.dev)
